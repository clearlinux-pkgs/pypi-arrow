...
Source0  : https://files.pythonhosted.org/packages/dc/bd/2565b8533bb8cf66e10a9e68a1d489ad839799b2050f0635039e614e3b1a/arrow-1.2.0.tar.gz
...
%prep
%setup -q -n arrow-1.2.0
cd %{_builddir}/arrow-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633356829
...
cp %{_builddir}/arrow-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/arrow/1a3af28b6e1b31db5b0d5e4bcd7c1fe4dabe7f7e

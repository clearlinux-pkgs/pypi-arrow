...
Source0  : https://files.pythonhosted.org/packages/94/39/b5bb573821d6784640c227ccbd72fa192f7542fa0f68589fd51757046030/arrow-1.1.1.tar.gz
...
%prep
%setup -q -n arrow-1.1.1
cd %{_builddir}/arrow-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624554279
...
cp %{_builddir}/arrow-1.1.1/LICENSE %{buildroot}/usr/share/package-licenses/arrow/1a3af28b6e1b31db5b0d5e4bcd7c1fe4dabe7f7e
